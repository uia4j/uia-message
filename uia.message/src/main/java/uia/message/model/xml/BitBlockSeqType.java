    ...
    extends BlockBaseType
{
    ...
    protected List<BlockBaseType> blockOrBlockSeqOrBlockSeqList;
    @XmlAttribute(name = "className", required = true)
    protected String className;

    /**
     * Gets the value of the blockOrBlockSeqOrBlockSeqList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the blockOrBlockSeqOrBlockSeqList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBlockOrBlockSeqOrBlockSeqList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BlockBaseType> getBlockOrBlockSeqOrBlockSeqList() {
        if (blockOrBlockSeqOrBlockSeqList == null) {
            blockOrBlockSeqOrBlockSeqList = new ArrayList<BlockBaseType>();
        }
        return this.blockOrBlockSeqOrBlockSeqList;
    }
