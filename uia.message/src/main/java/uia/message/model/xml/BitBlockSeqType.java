    ...
    extends BlockBaseType
{
    ...
    protected List<BlockBaseType> blockOrBlockSeqOrBlockList;
    @XmlAttribute(required = true)
    protected String className;

    /**
     * Gets the value of the blockOrBlockSeqOrBlockList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the blockOrBlockSeqOrBlockList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBlockOrBlockSeqOrBlockList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BlockBaseType> getBlockOrBlockSeqOrBlockList() {
        if (blockOrBlockSeqOrBlockList == null) {
            blockOrBlockSeqOrBlockList = new ArrayList<BlockBaseType>();
        }
        return this.blockOrBlockSeqOrBlockList;
    }
