 ...
 * @author Kyle
 */
public class DataExCodecTest2 {

    @Test
    public void testDecode1() throws Exception {
        DataExType dxType = XObjectReader.run(DataExType.class, DataExCodecTest2.class.getResourceAsStream("Rcv.xml"));
    ...
    public void testDecode2() throws Exception {
        DataExType dxType = XObjectReader.run(DataExType.class, DataExCodecTest2.class.getResourceAsStream("onbonv5.xml"));
        print(dxType.getBlockSpace());
        System.out.println();
    ...
    private void print(BitBlockSeqType seq) {
        System.out.println(String.format("  seq> %1$-15s> %2$s - %3$s",
                ...
                seq.getClassName(),
                seq.getDesc()));
        for (Object block : seq.getBlockOrBlockListOrBlockSeq()) {
            if (block instanceof BitBlockRefType) {
                print((BitBlockRefType) block);
            }
            else if (block instanceof BitBlockSeqListType) {
